...
\end{figure}\\
Ved å anvende Kirchhoffs spenningslov (se ligning (1)) på segmentet får vi:
\[
    u(x,t) - u(x+\Delta x,t) = R \Delta x \cdot i(x,t) + L \Delta x \cdot \frac{\partial i(x,t)}{\partial t} .
\]
Når vi deler begge sider av ligningen på $\Delta x$ og lar $\Delta x \to 0$, får vi uttrykket for spenningsendringen langs linjen slik det ble vist tidligere ved Kirchhoffs spenningslov.
\\
\\Tilsvarende, ved å bruke Kirchhoffs strømlov (se ligning (2)), får vi:
\[
