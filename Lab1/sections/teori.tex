...
Ledningsevnen per meter $[\mathrm{S}/\mathrm{m}]$ beskriver det dielektriske tap gjennom isolasjonen til jord, per meter. Det påvirker signalet i form av å øke dempingen fordi energi vil lekke i dielektrikumet. Høy fuktighet eller dårlig isolasjon vil øke lekkasje. Ledningsevnen står parallelt med kapasitansen i linjemodellen.
...
\begin{itemize}[leftmargin=2.8em,style=nextline]
  ...
  \item Et virkelig dielektrikum er ikke tapsfritt: polarisasjonen henger litt etter feltet (faseforsinkelse), noe som kan modelleres med \emph{loss tangent} \(\tan\delta\). For små tap får vi den nyttige tilnærmingen
  \[
