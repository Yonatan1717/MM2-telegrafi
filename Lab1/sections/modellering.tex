...
\]
For å simulere dette numerisk, kan vi bruke Python til å beregne $H(f, \ell)$ for en rekke frekvenser og deretter rekonstruere tidsdomenesignalet ved hjelp av den inverse Fourier-transformasjonen.
