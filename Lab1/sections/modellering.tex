...
\begin{figure}[h]
    ...
    \textit{
        \caption{Waterfall plot som viser hvordan tidsdomenesignalet endres når flere frekvenskomponenter inkluderes opp til/ned til forskjellige grensefrekvenser (plottet er for 50m kabel).}}
    \label{fig:modell6}
\end{figure}\\
