...
\]
For å modellere dempingen i mediet, antar vi en en tilnærment lik realistiske tilnærminger for R, G, L og C.
...
\end{itemize}
\clearpage
\subsection{Modell 1 (kunn demping i frekvensdomenet)}
...
I den andre modellen ser vi på hvordan tidsdomenesignalet endres etter å ha passert gjennom mediet. Vi rekonstruerer tidsdomenesignalet ved å summerer Fourier-rekkene for de dempede harmoniske. Her har vi kunn tatt hensyn til amplitudendringen og ikke faseendringen. alstå ser vi på:
\[
...
\end{figure}
\clearpage
\subsection{Modell 3 (kunn faseendring)}
...
pulsen opprettholder sin form og blir forsinket i tid, akkurat som i modell 3. Dette bekrefter at i et ideelt ikke-dispersivt medium, har alle frekvenskomponenter samme fasehastighet, noe som betyr at signalets form bevares uten noen forvrengning.
\begin{figure}[h]
    \centering
